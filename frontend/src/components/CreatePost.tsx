...
import PostType from "../contracts/post.js";
...
const CreatePost = () => {
	...
	const handleTextChange = (e: ChangeEvent & { target: EventTarget & { value: string } }) => {
	...
	const handleCreatePost = async () => {
		...
		try {
			if (postText.trim() == "") showToast("Error", "Your post must contain text", "error");
				...
				const data: PostType & { success?: string | boolean, error?: string } = await res.json();
				if (data.error) {
